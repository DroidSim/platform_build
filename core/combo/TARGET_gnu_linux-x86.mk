...
ifeq ($(TARGET_OS),gnu_linux)
KERNEL_HEADERS_COMMON := $(TOPDIR)external/kernel-headers/original/uapi
# x86 covers both x86 and x86_64.
KERNEL_HEADERS_ARCH   := $(TOPDIR)external/kernel-headers/original/uapi/asm-x86
else
...
android_config_h := $(call select-android-config-h,target_gnu_linux-x86)
